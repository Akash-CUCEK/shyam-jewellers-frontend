...
import GoldLoanFormUser from "./GoldLoanFormUser";
import {
  Plus,
  Search,
  Filter,
...
export default function GoldLoanInquiryUser() {
    ...
    return (
      <div className="text-center py-20">
        ...
        <h2 className="text-2xl font-bold text-[#7c1d1d]">
          PLEASE LOGIN TO REQUEST GOLD LOAN
        </h2>
    ...
    <div className="p-6 bg-[#fdf9f4] min-h-screen text-[#2c2c2c]">
      ...
      <div className="bg-white rounded-xl shadow-sm overflow-x-auto">
        <table className="w-full text-sm text-left">
          ...
          <tbody>
            {dummyGoldLoanRequests.map((item) => (
      ...
      {/* Modal Form */}
      {showFormModal && (
        <GoldLoanFormUser onClose={() => setShowFormModal(false)} />
      )}
    </div>
  );
}
