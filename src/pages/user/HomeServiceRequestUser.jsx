...
import HomeServiceFormUser from "./HomeServiceFormUser";
import {
  Plus,
  Search,
  Filter,
...
const dummyHomeRequests = [
  {
    id: "HSR001",
    serviceType: "Gold Cleaning at Home",
    date: "2025-07-02",
    status: "Completed",
...
export default function HomeServiceRequestUser() {
    ...
    return (
      <div className="text-center py-20">
        ...
        <h2 className="text-2xl font-bold text-[#7c1d1d]">
          PLEASE LOGIN TO REQUEST HOME SERVICE
        </h2>
  ...
  return (
    <div className="p-6 bg-[#fdf9f4] min-h-screen text-[#2c2c2c]">
      ...
      {/* Modal outside table */}
      {showFormModal && (
        <HomeServiceFormUser onClose={() => setShowFormModal(false)} />
      )}
    </div>
  );
}
